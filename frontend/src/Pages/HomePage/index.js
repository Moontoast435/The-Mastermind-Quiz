        ...
        <div id="welcome">
            ...
            <form autoComplete="off">
                ...
                <div className="button-container" style={{ display: "flex", justifyContent: "center" }}>
                    <button type="submit" name="newQuiz" className="newQuiz" value="New Game" onClick={handleCreate}>
                        <span></span>
                        <span></span>
                        <span></span>
                        <span></span>
            ...
            <div>
                {playerCount <= 0 ? "No Quizzers Online" : `Quizzers Online: ${playerCount}`}
            ...
            <footer>
                <p>
                    ...
                    <a href="https://github.com/trinayau/QuizProQuo" target="_blank">
                        GitHub
                    </a>
                </p>
            </footer>
